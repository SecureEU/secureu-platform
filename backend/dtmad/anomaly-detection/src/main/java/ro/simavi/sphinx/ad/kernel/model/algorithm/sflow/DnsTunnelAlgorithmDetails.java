...
@Setter
@ToString
public class DnsTunnelAlgorithmDetails extends SFlowAlgorithmDetails {
    ...
    public DnsTunnelAlgorithmDetails(String hostname, String bytesUp, String bytesDown, String numberPkts, String stringFlows, String connections){
        super("DnsTunnel_sflow");
