...
func _EvtClearLog(session wineventlog.EvtHandle, channelPath *uint16, targetFilePath *uint16, flags uint32) (err error) {
...
func _EvtClose(object wineventlog.EvtHandle) (err error) {
...
func _EvtCreateBookmark(bookmarkXML *uint16) (handle wineventlog.EvtHandle, err error) {
	r0, _, e1 := syscall.Syscall(procEvtCreateBookmark.Addr(), 1, uintptr(unsafe.Pointer(bookmarkXML)), 0, 0)
	handle = wineventlog.EvtHandle(r0)
	if handle == 0 {
		err = errnoErr(e1)
	}
	return
...
func _EvtCreateRenderContext(ValuePathsCount uint32, valuePaths **uint16, flags wineventlog.EvtRenderContextFlag) (handle wineventlog.EvtHandle, err error) {
...
func _EvtFormatMessage(publisherMetadata wineventlog.EvtHandle, event wineventlog.EvtHandle, messageID uint32, valueCount uint32, values * wineventlog.EvtVariant, flags  wineventlog.EvtFormatMessageFlag, bufferSize uint32, buffer *byte, bufferUsed *uint32) (err error) {
...
func _EvtGetEventMetadataProperty(eventMetadata wineventlog.EvtHandle, propertyID wineventlog.EvtEventMetadataPropertyID, flags uint32, bufferSize uint32, variant * wineventlog.EvtVariant, bufferUsed *uint32) (err error) {
...
func _EvtGetObjectArrayProperty(objectArray  wineventlog.EvtObjectArrayPropertyHandle, propertyID  wineventlog.EvtPublisherMetadataPropertyID, arrayIndex uint32, flags uint32, bufferSize uint32, evtVariant * wineventlog.EvtVariant, bufferUsed *uint32) (err error) {
...
func _EvtGetObjectArraySize(objectArray  wineventlog.EvtObjectArrayPropertyHandle, arraySize *uint32) (err error) {
...
func _EvtGetPublisherMetadataProperty(publisherMetadata wineventlog.EvtHandle, propertyID  wineventlog.EvtPublisherMetadataPropertyID, flags uint32, bufferSize uint32, variant * wineventlog.EvtVariant, bufferUsed *uint32) (err error) {
...
func _EvtNext(resultSet wineventlog.EvtHandle, eventArraySize uint32, eventArray *wineventlog.EvtHandle, timeout uint32, flags uint32, numReturned *uint32) (err error) {
...
func _EvtNextChannelPath(channelEnum wineventlog.EvtHandle, channelPathBufferSize uint32, channelPathBuffer *uint16, channelPathBufferUsed *uint32) (err error) {
...
func _EvtNextEventMetadata(enumerator wineventlog.EvtHandle, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtNextPublisherId(enumerator wineventlog.EvtHandle, bufferSize uint32, buffer *uint16, bufferUsed *uint32) (err error) {
...
func _EvtOpenChannelEnum(session wineventlog.EvtHandle, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtOpenEventMetadataEnum(publisherMetadata wineventlog.EvtHandle, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtOpenLog(session wineventlog.EvtHandle, path *uint16, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtOpenPublisherEnum(session wineventlog.EvtHandle, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtOpenPublisherMetadata(session wineventlog.EvtHandle, publisherIdentity *uint16, logFilePath *uint16, locale uint32, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtQuery(session wineventlog.EvtHandle, path *uint16, query *uint16, flags uint32) (handle wineventlog.EvtHandle, err error) {
...
func _EvtRender(context wineventlog.EvtHandle, fragment wineventlog.EvtHandle, flags  wineventlog.EvtRenderFlag, bufferSize uint32, buffer *byte, bufferUsed *uint32, propertyCount *uint32) (err error) {
...
func _EvtSeek(resultSet wineventlog.EvtHandle, position int64, bookmark wineventlog.EvtHandle, timeout uint32, flags uint32) (success bool, err error) {
	var (
		r0 uintptr
		e1 syscall.Errno
	)
...
func _EvtSubscribe(session wineventlog.EvtHandle, signalEvent uintptr, channelPath *uint16, query *uint16, bookmark wineventlog.EvtHandle, context uintptr, callback uintptr, flags  wineventlog.EvtSubscribeFlag) (handle wineventlog.EvtHandle, err error) {
	r0, _, e1 := syscall.Syscall9(procEvtSubscribe.Addr(), 8, uintptr(session), uintptr(signalEvent), uintptr(unsafe.Pointer(channelPath)), uintptr(unsafe.Pointer(query)), uintptr(bookmark), uintptr(context), callback, uintptr(flags), 0)
	handle = wineventlog.EvtHandle(r0)
	if handle == 0 {
		err = errnoErr(e1)
	}
...
func _EvtUpdateBookmark(bookmark wineventlog.EvtHandle, event  wineventlog.EvtHandle) (err error) {
