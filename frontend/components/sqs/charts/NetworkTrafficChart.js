...
export default function NetworkTrafficChart({ data }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-4">
      <h3 className="text-lg font-semibold mb-4 text-gray-800">Network Traffic</h3>
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={chartData}>
          ...
          <Legend />
          <Area type="monotone" dataKey="outbound" stackId="1" stroke="#4338ca" fill="#4338ca" fillOpacity={0.7} name="Outbound" />
          <Area type="monotone" dataKey="inbound" stackId="2" stroke="#6366f1" fill="#6366f1" fillOpacity={0.7} name="Inbound" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  )
